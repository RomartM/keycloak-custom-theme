...
export class SampleOverview extends React.Component {
    render() {
        ...
        return e('div', {class: 'pf-c-card'}, [
            e('center', null, e("img", {class: 'pf-c-brand', src: resourceUrl + '/public/keycloak-extended-theme-95x95.jpg', alt: 'Keycloak Man Logo'})),
            ...
            e('div', {class: 'pf-c-card__body'}, [
                e('strong', null, '/resources/content/keycloak-extended-theme/who-is-keycloak-extended-theme.js: '),
                e('span', null, `This page demonstrates calling the Keycloak Account REST API.`)
            ]),

            e('div', {class: 'pf-c-card__body'}, [
                e('strong', null, '/resources/content/keycloak-extended-theme/sample-overview.js: '),
